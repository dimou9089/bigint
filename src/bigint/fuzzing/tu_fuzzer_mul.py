...
lib.mul.argtypes = [ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_uint8),ctypes.POINTER(ctypes.c_uint8)]
...
# Appel
    lib.mul(a_param,b_param,c_param)
    c_int=concat(c_param)

    s=(a_int*b_int)%modulo
